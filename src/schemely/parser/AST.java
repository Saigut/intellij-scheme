...
public interface AST extends Tokens
{
  ...
  final IElementType AST_SPECIAL_LITERAL = new SchemeElementType("ast special literal");
  ...
  final IElementType AST_BAD_ELEMENT = new SchemeElementType("ast bad element");
  ...
  TokenSet AST_ELEMENTS = TokenSet.create(AST_LIST, AST_VECTOR,
          AST_PLAIN_LITERAL, AST_SPECIAL_LITERAL, AST_IDENTIFIER, AST_KEYWORD,
          AST_SPECIAL, AST_QUOTED, AST_BACKQUOTED, AST_BAD_ELEMENT);
