 ...
 */
@State(name = "SchemeCompilerSettings", storages = {@Storage(file = "$PROJECT_FILE$"),
...
public class SchemeCompilerSettings implements PersistentStateComponent<SchemeCompilerSettings>, ProjectComponent {
	...
	@Override public SchemeCompilerSettings getState() {
		return this;
	}

	@Override public void loadState(SchemeCompilerSettings state) {
