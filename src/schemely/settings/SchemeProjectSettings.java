...
@State(name = SchemeConfigurable.PROJECT_SETTINGS, storages = {@Storage(file = "scheme_project.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class SchemeProjectSettings implements PersistentStateComponent<SchemeProjectSettings> {
	...
	@Override public SchemeProjectSettings getState() {
		return this;
	}

	@Override public void loadState(SchemeProjectSettings state) {
