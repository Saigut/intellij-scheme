...
public class SchemeColorsAndFontsPage implements ColorSettingsPage {
	...
	private static final AttributesDescriptor[] ATTRS = new AttributesDescriptor[]{desc(SchemeSyntaxHighlighter.IDENTIFIER_ID,
			SchemeSyntaxHighlighter.IDENTIFIER),
	...
	@NonNls @NotNull public String getDemoText() {
	...
	@Nullable public Map<String, TextAttributesKey> getAdditionalHighlightingTagToDescriptorMap() {
